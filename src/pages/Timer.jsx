...
export default function Timer() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto py-4 px-3 sm:px-6 space-y-6">
      ...
      {isCompleted ? (
        <div className="w-full max-w-xl mx-auto p-8 rounded-3xl bg-nocturn-card border border-nocturn-border flex flex-col items-center justify-center text-center space-y-4 shadow-lg">

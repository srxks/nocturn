...
export default function Vocab() {
  ...
  const handleStartLearn = async () => {
    try {
      if (todayGeneratedWords.length < 5) {
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            ...
            <span className="px-3 py-1 rounded-full text-xs font-semibold bg-nocturn-accent/15 text-nocturn-accent border border-nocturn-accent/30 shadow-[0_0_12px_rgba(0,230,118,0.2)]">
              GRE Flashcards
            </span>
          </div>
        ...
        <div className="bg-nocturn-card border border-nocturn-border rounded-3xl p-6 sm:p-8 flex flex-col justify-between hover:border-nocturn-accent/40 transition-colors duration-200 shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div className="w-10 h-10 rounded-2xl bg-nocturn-accent/15 border border-nocturn-accent/30 flex items-center justify-center text-nocturn-accent shadow-[0_0_12px_rgba(0,230,118,0.2)]">
            ...
            <div>
              ...
              <p className="text-nocturn-muted text-sm mt-1">
                Daily GRE vocabulary set generated online by Gemini AI.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white/[0.02] border border-nocturn-border/60 space-y-2">
              <div className="flex items-center justify-between text-xs font-medium">
                ...
                <span className="text-white font-bold">
                  {learnedTodayCount} / 5 Words
                </span>
              </div>
              <div className="w-full h-2 rounded-full bg-white/5 overflow-hidden border border-nocturn-border/40">
                <div
                  className="h-full bg-nocturn-accent transition-all duration-300 rounded-full shadow-[0_0_8px_rgba(0,230,118,0.4)]"
                  style={{ width: `${(learnedTodayCount / 5) * 100}%` }}
                />
              </div>
            </div>
          </div>
          ...
          <div className="pt-6">
            {isDailyCompleted ? (
              ...
              <button
                ...
                className="w-full py-3.5 px-6 rounded-2xl bg-nocturn-accent text-black font-bold hover:bg-nocturn-accent-bright shadow-[0_0_15px_rgba(0,230,118,0.3)] transition-all duration-200 flex items-center justify-center gap-2 text-sm disabled:opacity-50"
              >
                {isGenerating ? (
                  <>
      ...
      <div className="bg-nocturn-card border border-nocturn-border rounded-3xl p-6 sm:p-8 space-y-6 shadow-[0_8px_30px_rgba(0,0,0,0.4)]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="p-4 rounded-2xl bg-white/[0.02] border border-nocturn-border/60">
            <p className="text-xs text-nocturn-muted font-medium">In Progress (0-4/5)</p>
            <p className="text-2xl font-extrabold text-nocturn-accent mt-1">
              {learningCount}
            </p>
          </div>
          <div className="p-4 rounded-2xl bg-white/[0.02] border border-nocturn-border/60">
            <p className="text-xs text-nocturn-muted font-medium">Settled (5/5)</p>

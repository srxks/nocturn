...
export default function EmptyTasks() {
  return (
    <div className="nocturn-card p-8 sm:p-10 text-center flex flex-col items-center justify-center space-y-3.5 my-6 border border-nocturn-border">
      <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-3xl bg-nocturn-accent/15 border border-nocturn-accent/30 flex items-center justify-center shadow-[0_0_20px_rgba(0,230,118,0.25)] text-nocturn-accent">

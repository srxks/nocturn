...
export default function BottomNav() {
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-xl bg-nocturn-card/95 backdrop-blur-xl border border-nocturn-border shadow-[0_12px_40px_rgba(0,0,0,0.9)] px-1 sm:px-3 py-1.5 flex items-center justify-between pointer-events-auto overflow-x-auto no-scrollbar ${
          isAngular ? 'rounded-none angular-chamfer font-mono' : 'rounded-2xl sm:rounded-3xl'
        }`}
      >
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex-1 min-w-0 flex flex-col items-center justify-center gap-0.5 py-1 px-0.5 transition-all duration-200 select-none ${

    ...
    >
      ...
      <div className="space-y-8">
        <div className="flex items-center gap-3 px-2">
          <div className="w-10 h-10 rounded-2xl bg-nocturn-accent/15 border border-nocturn-accent/30 flex items-center justify-center shadow-[0_0_15px_rgba(var(--color-nocturn-accent-rgb),0.3)]">
      ...
      <div className="pt-4 border-t border-nocturn-border/60 px-2">
        <div className="flex items-center gap-2">
          <span className="w-2 h-2 rounded-full bg-nocturn-accent shadow-[0_0_8px_rgba(var(--color-nocturn-accent-rgb),0.8)] animate-pulse" />
